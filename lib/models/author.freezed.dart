...
abstract class $AuthorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uuid, String title, String description, String? imageUrl});
}
...
class _$_Author implements _Author {
  ...
  @override
  String toString() {
    return 'Author(uuid: $uuid, title: $title, description: $description, imageUrl: $imageUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, uuid, title, description, imageUrl);
...
abstract class _Author implements Author {
  const factory _Author(
      ...
      required final String? imageUrl}) = _$_Author;
